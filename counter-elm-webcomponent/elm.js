...
var _kevinlebrun$elm_polymer_sandbox$Component$Decrement = {ctor: 'Decrement'};
var _kevinlebrun$elm_polymer_sandbox$Component$Increment = {ctor: 'Increment'};
var _kevinlebrun$elm_polymer_sandbox$Component$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_kevinlebrun$elm_polymer_sandbox$Component$Decrement)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_kevinlebrun$elm_polymer_sandbox$Component$Increment)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('+')
...
var _kevinlebrun$elm_polymer_sandbox$Component$main = {
	main: _elm_lang$html$Html_App$programWithFlags(
		{
			init: _kevinlebrun$elm_polymer_sandbox$Component$init,
